...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        String postData = "{'id': 100001122234, userId: 112222233223, appId: sdfslfsldflsdfsfs" +
                ", areaInfo: '四川省成都市新怡华庭西区', pageId: 'hasfs', 'buttonId': 'sdfssd', time: 'sdfsdfsdfs}";
        System.out.println(postData.getBytes().length
                );
    }
}
